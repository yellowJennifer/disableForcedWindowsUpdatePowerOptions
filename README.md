...
as a band-aid fix, I added the file (a shortcut is fine too) to `shell:startup` or `C:\Users\(YourUser)\AppData\Roaming\Microsoft\Windows\Start Menu\Programs\Startup` (same folder), so it just prompts you to press yes every time you boot up your system. <br><br>
